            ...
            <CardContent className="p-8 space-y-6">
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  By accessing and using BookHive, you accept and agree to be bound by the terms
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  You agree to use BookHive only for lawful purposes and in accordance with these
                  Terms. You agree not to:
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li>Use the service in any way that violates any applicable law or regulation</li>
                  <li>Impersonate or attempt to impersonate BookHive or another user</li>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  responsible for safeguarding your password and for all activities under your
                  account.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  We will make reasonable efforts to deliver your order within the estimated
                  timeframe. However, we are not responsible for delays caused by circumstances
                  beyond our control. Risk of loss and title for items pass to you upon delivery.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Refunds will be processed within 5-7 business days of receiving the returned
                  item. Shipping costs are non-refundable unless the return is due to our error.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  BookHive and are protected by international copyright, trademark, patent, trade
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  BookHive shall not be liable for any indirect, incidental, special, consequential,
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  You agree to indemnify and hold BookHive harmless from any claims, damages,
                  losses, liabilities, and expenses arising out of your use of the service or
              ...
              <section>
                ...
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <p className="text-gray-700">
                    <strong>Email:</strong> legal@bookhive.com
                  </p>
                  <p className="text-gray-700">
